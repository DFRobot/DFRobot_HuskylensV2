...
def main():
    """主函数"""
    parser = argparse.ArgumentParser(description='二哈识图V2 MQTT视线识别测试')
    ...
    parser.add_argument('--algorithm', type=int, default=ALGORITHM_GAZE_RECOGNITION,
                        help=f'要测试的算法ID (默认: {ALGORITHM_GAZE_RECOGNITION} - 视线识别)')
    ...
    print(f"  测试算法ID: {args.algorithm} (视线识别)")
    print()
