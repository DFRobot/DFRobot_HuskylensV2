...
def main():
    """主函数"""
    parser = argparse.ArgumentParser(description='二哈识图V2 MQTT车牌识别测试')
    ...
    parser.add_argument('--algorithm', type=int, default=ALGORITHM_LICENSE_RECOGNITION,
                        help=f'要测试的算法ID (默认: {ALGORITHM_LICENSE_RECOGNITION} - 车牌识别)')
    ...
    print(f"  测试算法ID: {args.algorithm} (车牌识别)")
    print()
