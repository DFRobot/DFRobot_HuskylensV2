...
def main():
    """主函数"""
    parser = argparse.ArgumentParser(description='二哈识图V2 MQTT物体分类测试')
    ...
    parser.add_argument('--algorithm', type=int, default=ALGORITHM_OBJECT_CLASSIFICATION,
                        help=f'要测试的算法ID (默认: {ALGORITHM_OBJECT_CLASSIFICATION} - 物体分类)')
    ...
    print(f"  测试算法ID: {args.algorithm} (物体分类)")
    print()
