...
def main():
    """主函数"""
    parser = argparse.ArgumentParser(description='二哈识图V2 MQTT实例分割测试')
    ...
    parser.add_argument('--algorithm', type=int, default=ALGORITHM_SEGMENT,
                        help=f'要测试的算法ID (默认: {ALGORITHM_SEGMENT} - 实例分割)')
    ...
    print(f"  测试算法ID: {args.algorithm} (实例分割)")
    print()
