...
def main():
    """主函数"""
    parser = argparse.ArgumentParser(description='二哈识图V2 MQTT姿态识别测试')
    ...
    parser.add_argument('--algorithm', type=int, default=ALGORITHM_POSE_RECOGNITION,
                        help=f'要测试的算法ID (默认: {ALGORITHM_POSE_RECOGNITION} - 姿态识别)')
    ...
    print(f"  测试算法ID: {args.algorithm} (姿态识别)")
    print()
