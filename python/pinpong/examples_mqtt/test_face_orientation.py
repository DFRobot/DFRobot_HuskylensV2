...
def main():
    """主函数"""
    parser = argparse.ArgumentParser(description='二哈识图V2 MQTT人脸朝向测试')
    ...
    parser.add_argument('--algorithm', type=int, default=ALGORITHM_FACE_ORIENTATION,
                        help=f'要测试的算法ID (默认: {ALGORITHM_FACE_ORIENTATION} - 人脸朝向)')
    ...
    print(f"  测试算法ID: {args.algorithm} (人脸朝向)")
    print()
