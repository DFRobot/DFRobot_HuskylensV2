...
def main():
    """主函数"""
    parser = argparse.ArgumentParser(description='二哈识图V2 MQTT条形码识别测试')
    ...
    parser.add_argument('--algorithm', type=int, default=ALGORITHM_BARCODE_RECOGNITION,
                        help=f'要测试的算法ID (默认: {ALGORITHM_BARCODE_RECOGNITION} - 条形码识别)')
    ...
    print(f"  测试算法ID: {args.algorithm} (条形码识别)")
    print()
