...
def main():
    ...
    parser = argparse.ArgumentParser(description='二哈识图V2 MQTT真实通信测试')
    ...
    parser.add_argument('--algorithm', type=int, default=ALGORITHM_FACE_RECOGNITION,
                        help=f'要测试的算法ID (默认: {ALGORITHM_FACE_RECOGNITION})')
