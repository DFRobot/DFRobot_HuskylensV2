...
def main():
    """主函数"""
    parser = argparse.ArgumentParser(description='二哈识图V2 MQTT自学习分类测试')
    ...
    parser.add_argument('--algorithm', type=int, default=ALGORITHM_SELF_LEARNING_CLASSIFICATION,
                        help=f'要测试的算法ID (默认: {ALGORITHM_SELF_LEARNING_CLASSIFICATION} - 自学习分类)')
    ...
    print(f"  测试算法ID: {args.algorithm} (自学习分类)")
    print()
