...
def main():
    """主函数"""
    parser = argparse.ArgumentParser(description='二哈识图V2 MQTT二维码识别测试')
    ...
    parser.add_argument('--algorithm', type=int, default=ALGORITHM_QRCODE_RECOGNITION,
                        help=f'要测试的算法ID (默认: {ALGORITHM_QRCODE_RECOGNITION} - 二维码识别)')
    ...
    print(f"  测试算法ID: {args.algorithm} (二维码识别)")
    print()
