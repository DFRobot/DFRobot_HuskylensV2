...
def main():
    """主函数"""
    parser = argparse.ArgumentParser(description='二哈识图V2 MQTT物体追踪测试')
    ...
    parser.add_argument('--algorithm', type=int, default=ALGORITHM_OBJECT_TRACKING,
                        help=f'要测试的算法ID (默认: {ALGORITHM_OBJECT_TRACKING} - 物体追踪)')
    ...
    print(f"  测试算法ID: {args.algorithm} (物体追踪)")
    print()
