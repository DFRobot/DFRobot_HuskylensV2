...
from dfrobot_huskylensv2_mqtt import (
    DFRobot_HuskylensV2,
    ALGORITHM_FALLDOWN_RECOGNITION
)
...
def main():
    """主函数"""
    parser = argparse.ArgumentParser(description='二哈识图V2 MQTT跌倒识别测试')
    ...
    parser.add_argument('--algorithm', type=int, default=ALGORITHM_FALLDOWN_RECOGNITION,
                        help=f'要测试的算法ID (默认: {ALGORITHM_FALLDOWN_RECOGNITION} - 跌倒识别)')
    ...
    print(f"  测试算法ID: {args.algorithm} (跌倒识别)")
    print()
